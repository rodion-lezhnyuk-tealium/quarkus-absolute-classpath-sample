...
import io.quarkus.runtime.FixedClassPathSystemPropertyRecorder;
...
public class ClassPathSystemPropBuildStep {
	...
	public void set(
			List<SetClassPathSystemPropBuildItem> setCPItems,
			CurateOutcomeBuildItem curateOutcome,
			FixedClassPathSystemPropertyRecorder recorder
	) {
